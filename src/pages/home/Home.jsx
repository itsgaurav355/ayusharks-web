    ...
    <div className="bg-gray-900">
            ...
            {!currentUser ?  (
              <ul className="hidden lg:flex  items-center space-x-6">
                <li>
                  <Link
                    to={"/login"}
                    className="bg-blue-400 px-9 py-3 rounded-md capitalize font-bold hover:opacity-80 ease-in duration-200"
                  >
                    Login
                  </Link>
                </li>
          ...
          <div className="flex flex-col text-white items-center z-20 md:flex-row">
            <div className="text-center mb-12 md:text-left md:w-1/2 md:pr-10">
              <h1 className="title text-3xl font-bold text-center mb-4">
                आयुष प्रतिभावानां वैश्विक सम्बन्ध
                <br /> उत्सर्ग, सहकारः, समृद्धि !
              </h1>
              <p className="leading-relaxed text-center mb-10">
                One-stop platform for all stakeholders in the AYUSH system to
      ...
      <section id="features" className="bg-color-primary-light text-white">
        <div className="container py-20">
          <div className="text-center m-auto mb-20 md:w-1/2">
            ...
            <h1 className="font-bold title text-4xl">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12 lg:gap-8 px-4 sm:px-6 lg:px-8">
            <div className="border-2 border-solid border-color-gray text-center py-20 px-5 rounded-2xl cursor-pointer hover:bg-color-primary-dark ease-in duration-200">
              ...
              <p className="leading-relaxed">
                Where the entrepreneur has an interesting idea and is working on
                bringing it to life.
              </p>
            </div>
            ...
            <div className="bg-color-primary-dark border-2 border-solid border-color-gray text-center py-20 px-5 rounded-2xl cursor-pointer">
              ...
              <p className="leading-relaxed">
                Where the startup has been established and it is time to enter
                market to grasp the first ever set of customers.
              </p>
            </div>
            ...
            <div className="border-2 border-solid border-color-gray text-center py-20 px-5 rounded-2xl cursor-pointer hover:bg-color-primary-dark ease-in duration-200">
              ...
              <p className="leading-relaxed">
                Where the startup has established a mark with the first wave of
                customers and KPIs take an important place in the growth model.
              </p>
            </div>
            ...
            <div className="bg-color-primary-dark border-2 border-solid border-color-gray text-center py-20 px-5 rounded-2xl cursor-pointer">
              ...
              <p className="leading-relaxed">
                Where the startup has successfully achieved the
                product-market-fit and crossed the valley of death; for the
                startup to expand/raise capital.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container py-20 relative">
          ...
          <div className="flex flex-col text-white items-center justify-between md:flex-row">
            ...
            <div className="text-center md:text-left md:w-1/2 md:ml-20">
              ...
              <button className="btn px-9 py-3 bg-blue-400 rounded-md capitalize font-bold hover:opacity-80 ease-in duration-200">
                DOWNLOAD
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-between space-y-6 md:flex-row md:space-y-0 md:space-x-6">
            ...
            <div className="text-center cursor-pointer">
              <div className="relative bg-color-primary-dark inline-block px-6 py-3 rounded-lg cursor-pointer hover:bg-color-secondary ease-in duration-200">
                <p className="text-6xl lg:after:content-[''] lg:after:flex lg:after:absolute lg:after:top-4 lg:after:left-32 2xl:after:left-52 lg:after:bg-no-repeat lg:after:h-7 lg:after:w-52">
                  1
                </p>
              </div>
            ...
            <div className="text-center cursor-pointer">
              <div classn="box border-solid border-blue-200 relative inline-block px-6 py-3 rounded-lg cursor-pointer bg-color-secondary">
                <p className="text-6xl lg:after:content-[''] lg:after:flex lg:after:absolute lg:after:top-10 lg:after:left-32 2xl:after:left-52 lg:after:bg-no-repeat lg:after:h-7 lg:after:w-52">
                  2
                </p>
              </div>
      ...
      <section id="contact">
        <div className="container py-20 text-white">
          <div className="text-center m-auto mb-20 md:w-1/2">
            <h4 className="font-bold text-lg text-blue-400 mb-4">
              Have A Questation
            </h4>
          ...
          <form>
            <div className="w-full m-auto text-center md:w-2/3">
              ...
              <button className="btn mt-10 bg-blue-400 px-9 py-3 rounded-md capitalize font-bold hover:opacity-80 ease-in duration-200">
                Send Message
              </button>
            </div>
          </form>
